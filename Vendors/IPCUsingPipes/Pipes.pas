        ...
        try
            ...
            if OpenStdPipes then begin
                ...
                try
                    ...
                    //by Alexey Valuev - make the 2nd argument
                    //100% not a constant to avoid AV
                    //according to MSDN (https://msdn.microsoft.com/ru-ru/ms682425)
                    tempCommandLine := Copy(CommandLine, 0, Length(CommandLine));
                    // Create the process
                    if CreateProcess(Pointer(Application), Pointer(tempCommandLine),
